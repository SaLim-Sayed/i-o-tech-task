...
export interface ApiHeroContentHeroContent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    media: Schema.Attribute.Media<'files' | 'videos' | 'audios' | 'images'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiReviewReview extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    disacription_ar: Schema.Attribute.Blocks;
    disacription_en: Schema.Attribute.Blocks;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::review.review'
    > &
      Schema.Attribute.Private;
    message_ar: Schema.Attribute.Blocks;
...
export interface ApiSubscribersSubscribers extends Struct.CollectionTypeSchema {
  collectionName: 'subscriberss';
  info: {
    displayName: 'subscribers';
    pluralName: 'subscriberss';
    singularName: 'subscribers';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::subscribers.subscribers': ApiSubscribersSubscribers;
